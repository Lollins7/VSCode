...
1. The players in this paper are supposed to be equipped with an undirected and connected communication graph. Can I extent it to directed graph? In other words, can I conclude a same conclusion in directed graph?

2. The designed strategy in this paper is perfect in quadratic games, but not in nonquadratic games. Can I relax the conditions of the strategy or design a good strategy for nonquadratic games?

## 5、自我想法

1. 文中没有假设收益函数的具体形式，只需要与邻居通信，去估计其他玩家的行动，就可以达到纳什均衡了。这说明在满足本文给出的假设的前提下，函数的形式可以是任意的。
2. 
