...
1. Can I extend the edge-based algorithm to switching directed communication graph?
1. How to be robust when occur the occasional loss of communication on switching directed communication graph?
1. 
