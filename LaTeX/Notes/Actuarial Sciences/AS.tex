...
此式的左端表示在0时刻, $l_x$个人各自买了一份$n$ 年期的死亡保险, 保费总额为$l_x A_{x:\annu{n}}^1$. 一年后, 这笔钱的积累值为$(1+i)l_x A_{x:\annu{n}}^1$. 在$[0,1]$之间有$d_x$个人死去, 保险公司需给他们每人$1$ 元, 共$d_x$ 元. 若此时保险公司破产不干了, 他分给在1 时刻还活着的$l_{x+1}$个人每人$A_{x+1:\annu{n-1}}^1$ 元, 这正好够每个人去重新买一份$n-1$年期的死亡保险.
...
{\rm\bf(i)} $\overline{a}_{x} = \overline{a}_{x:\annu{n}} +{}_nE_x\overline{a}_{x+n}$
...
保险人支付的保险金现值为$V^{T(x)\land n}$，保费的现值为$\overline{P}(\overline{A_{x:\annu {n}}})$，$\overline{a}_{\annu{T(x)\land n}}$，其中$\overline{P}(\overline{A_{x:\annu {n}}})$为生死合险的年均衡净保费，签单损失量为:$$L=v^{T(x)\land n}-\overline{P}(\overline{A_{x:\annu {n}}})\overline{a}_{\annu{T(x)\land n}}=(1+\frac{\overline{P}(\overline{A_{x:\annu {n}}})}{\delta})v^{T(x)\land n}-\frac{\overline{P}(\overline{A_{x:\annu {n}}})}{\delta}$$.

在平衡准则下，\begin{align*}
    0 = E(L) = & E(V^{T(x)\land n}-\overline{P}(\overline{A_{x:\annu {n}}})\overline{a}_{\annu{T(x)\land n}})  \\
    =          & \overline{A}_{x:\annu{n}} - \overline{P}(\overline{A_{x:\annu {n}}})\overline{a}_{x:\annu{n}}
\end{align*}
我们可以推出:
\begin{align*}
    \overline{P}(\overline{A_{x:\annu {n}}}) = \frac{\overline{A}_{x:\annu n}}{\overline{a}_{x:\annu n}}
\end{align*}
由$\delta \overline{a}_{x:\annu n} + \overline{A}_{x:\annu n}=1$，可以得到:
\begin{align*}
...
\begin{align*}
    D(L) & = D\left((1+\frac{\overline{P}(\overline{A}_{x:\annu {n}})}{\delta})v^{T(x) \land n}-\frac{\overline{P}(\overline{A}_{x:\annu {n}})}{\delta}\right) \\
         & = \left(
    1-\frac{\overline{P}(\overline{A_{x:\annu {n}}})}{\delta}
    \right)^{2}\cdot D(V^{T(x)\land n})                                                                                                                        \\
         & = \left(
...
3.缴费期为$h$年的$n$年期定期寿险($h<n$)

(1)年均衡净保费记为$_{h}\overline{P}(\overline{A}^{1}_{x:\annu n
    })$.

(2)签字损失量: 最后的缴费时刻为$T(x)\land h$
$$L=v^{T(x)}I_{\{T(x)<n\}}-_{h}\overline{P}^{1}_{x:\annu n}\overline{a}_{\annu{T(x)\land h}}$$

(3)
\begin{align*}
    0 & = E(L) = \overline{A}^{1}_{x:\annu n} - _{h}\overline{P}(\overline{A}^{1}_{x:\annu n}) \overline{a}_{\annu{x:h} }     \\
      & \equiv _{h}\overline{P}(\overline{A}^{1}_{x:\annu n})=\frac{\overline{A}^{1}_{x:\annu n}}{\overline{a}_{\annu{x:h}}}.
\end{align*}
...
(1)缴费期为$h$年的终身寿险: $_{h}\overline{P}(\overline{A}_{x})=\frac{\overline{A}_{x}}{\overline{a}_{x:\annu h}}$

(2)缴费期为$h$年的延$n$年期终身生存年金: $_{h}\overline{P}(_{n|}\overline{a}_{x})=\frac{_{n|}\overline{a}_{x}}{\overline{a}_{x:\annu h}}$

(3)延期$n$年的终身生存年金: $\overline{P}(_{n|}\overline{a}_{x})=\frac{_{n|}\overline{a}_{x}}{\overline{a}_{x:\annu n}}$

(4)延期$n$年的终身死亡保险: $\overline{P}(_{n|}\overline{A}_{x})=\frac{_{n}\overline{A}_{x}}{\overline{a}_{x:\annu n}}$

\section{完全离散险种}
\begin{itemize}
    \item[{\bf\hei 一.}]{\bf\hei 保费等额分期缴纳}
\end{itemize}
保险金死亡年末支付的险种称为完全离散险种.

\begin{itemize}
    \item[{\bf\hei 二.}]{\bf\hei 完全离散终身寿险}
\end{itemize}

1. 年均衡净保费记为$P_{x}$，保险金现值为$V^{k(x)+1}$

保费的总现值为$P_{x}\ddot{a}_{\annu{K(x)+1}}$.
...
2. 签单损失量: $L=V^{(K(x)+1)\land n}-P_{x:\annu n}\ddot{a}_{\annu {(K(x)+1)\land n}}$.

3. 平衡准则下，$E(L)=0=A_{x:\annu n}-P_{x:\annu n}\ddot{a}_{x:\annu n}$
\begin{align*}
    \Rightarrow P_{x:\annu n} & =\frac{A_{x:\annu n}}{\ddot{a}_{x:\annu n}} \\
                              & =\frac{dA_{x:\annu n}}{1-A_{x:\annu n}}     \\
                              & =\frac{1}{\ddot a_{x:\annu n}}-d
\end{align*}.

4. $D(L)=\frac{ ^{2}A_{x:\annu n}-(A_{x:\annu n})^{2}}{(1-A_{x:\annu n})^{2}}$

\begin{align*}
    \text{完全离散险种的年均衡净保费}=\frac{\text{对应险种的精算现值}}{\text{对应缴纳期的期初生存年金}}
\end{align*}

\begin{itemize}
    \item[{\bf\hei 四.}]{\bf\hei 其他完全离散险种}
\end{itemize}

1. 缴费期为$n$年的终身死亡保险:
$_{h}P(A_{x})=\frac{A_{x}}{\ddot{a}_{x:\annu n}}$.

2. $n$年期生存保险:
$P_{x:\annu n}^{\ \ 1}=\frac{A_{x:\annu n}^{\ \ 1}}{\ddot a_{x:\annu n}}$.

3. 延期$n$年的终身期初生存年金:
$P(_{n|\ddot a_{x}})=\frac{_{n|}\ddot a_{x}}{\ddot{a}_{x:\annu n}}$.

4. 缴费期为$h$年的$n$年期死亡保险:
$_{n}P^{1}_{x:\annu n}=\frac{A^{1}_{x:\annu n}}{a_{x:\annu h}}$.
...
\end{exs}
\begin{exs}
    某人现年$20$岁, 买了一份完全连续的终身寿险, 设$\delta=0.05$, 死亡立即支付保险金$10000$元,且其余命服从$[0,80]$上的均匀分布.
...
\begin{align*}
    {}_t\overline V(\overline A_{x:\annu n}) & =E(_tL|T(x)>t)                                                                                                              \\
                                             & =E(v^{(T(x)-t)\land(n-t)}-\overline P(A_{x:\annu n})\overline{a}_{\annu {(T(x)-t)\land(n-t)}})                              \\
...
3. 未来损失量${}_tL$的方差
\begin{align*}
    D(_tL|T(x)>t) & =D((1+\frac{\overline P(\overline A_{x:}{}\annu n)}{\delta})v^{(T(x)-t)\land(n-t)}-\frac{\overline P(\overline A_{x:}{}\annu n)}{\delta}|T(x)>t) \\
                  & =D(\frac{1}{\delta\overline a_{x:}{}\annu n}v^{(T(x)-t)\land(n-t)})=\frac{D(v^{(T(x)-t)\land(n-t)})}{(\delta\overline a_{x:}{}\annu n)^2}        \\
...
回忆一下, 在平衡准则下, 完全离散终身寿险的年均衡净保费$P_{x:}{}\annu{n}=\frac{A_{x:}{}\annu{n}}{\ddot a_{x:}{}\annu{n}}.$


1.未来损失量
\begin{align*}
    {}_kL & =(v^{(K(x)-k+1)\wedge (n-k)}-P_{x:}{}\annu{n} \ddot a_{\annu {(K(x)-k+1)\wedge (n-k)}})I_{\{K(x)\ge k\}}     \\
          & =[(1+\frac{P_{x:}{}\annu{n} }{d})v^{(K(x)-k+1)\wedge (n-k)}-\frac{P_{x:}{}\annu{n}}{d}] I_{\{K(x)\ge k\}}    \\
          & =[\frac{1}{d\ddot a_{x:}{}\annu{n}}v^{(K(x)-k+1)\wedge (n-k)}-\frac{P_{x:}{}\annu{n} }{d}]I_{\{K(x)\ge k\}}.
\end{align*}

2. 在平衡准则下
\begin{align*}
    {}_kV(A_{x:}{}\annu{n}) & =E({}_kL|T(x)>k)                                                                                                   \\
                            & =E((v^{(K(x)-k+1)\wedge (n-k)}-P_{x:}{}\annu{n} \ddot a_{\annu {(K(x)-k+1)\wedge (n-k)}})I_{\{K(x)\ge k\}}|T(x)>k) \\
                            & =E((v^{(K(x)-k+1)\wedge (n-k)}-P_{x:}{}\annu{n} \ddot a_{\annu {(K(x)-k+1)\wedge (n-k)}})I_{\{K(x)\ge k\}}|X>x+k)  \\
                            & =E(v^{((K(x+k)+1)\wedge (n-k))}-P_{x:}{}\annu{n}\ddot a_{\annu {((K(x+k)+1)\wedge (n-k)}})                         \\
                            & =E(v^{((K(x+k)+1)\wedge (n-k)})-P_x E(\ddot a_{\annu {((K(x+k)+1)\wedge (n-k)}})                                   \\
                            & = A_{x+k:}{}\annu{n-k}-P_{x:}{}\annu{n}\ddot a_{x+k:}{}\annu{n-k}                                                  \\
                            & = A_{x+k:}{}\annu{n-k}-\frac{A_{x:}{}\annu{n}}{\ddot a_{x:}{}\annu{n}}\ddot a_{x+k:}{}\annu{n-k}                   \\
                            & =1-d\ddot a_{x+k:}{}\annu{n-k}-\frac{1-d \ddot a_{x:}{}\annu{n}}{\ddot a_x}\ddot a_{x+k:}{}\annu{n-k}              \\
                            & =\frac{\ddot a_{x:}{}\annu{n}-\ddot a_{x+k:}{}\annu{n-k}}{\ddot a_{x:}{}\annu{n}}.
\end{align*}

3. 未来损失量$_kL$的方差
\begin{align*}
    D(_kL & |T(x)>k)=D([\frac{1}{d\ddot a_{x:}{}\annu{n}}v^{(K(x)-k+1)\wedge (n-k)}-\frac{P_{x:}{}\annu{n} }{d}]I_{\{K(x)\ge k\}}|T(x)>k)                                                \\
          & =D([\frac{1}{d\ddot a_{x:}{}\annu{n}}v^{(K(x)-k+1)\wedge (n-k)}-\frac{P_{x:}{}\annu{n} }{d}]I_{\{K(x)\ge k\}}|X>x+k)                                                         \\
          & =D(\frac{1}{d\ddot a_{x:}{}\annu{n}}v^{(K(x+k)+1)\wedge (n-k)}-\frac{P_{x:}{}\annu{n} }{d})
    =\frac{1}{(d\ddot a_{x:}{}\annu{n})^2}D(v^{(K(x)-k+1)\wedge (n-k)})                                                                                                                  \\
