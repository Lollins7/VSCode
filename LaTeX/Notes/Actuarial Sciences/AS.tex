...
\begin{itemize}
    \item[{\bf\hei 5.}]{\bf\hei 性质:${}_{m|}\overline {A}_{x}={}_mE_x\cdot \overline {A}_{x+m} $}
...
\begin{align*}
    {}_{m|}{A}_{x} & =E(Z)                                                                                \\
                   ...
                   & =E\left(v^{K\left(x\right)+1}I_{\left\{1<\left(K(x\right)\geq m\right\}}\right)      \\
...
\noindent$0 \leq S(x)<1$,$0\leq mS(x)<m$, 令$J(x)=[mS(x)]$, 它表示$mS(x)$的整数部分, 于是有$0\leq J(x)<m-1$, 易知$J(x)\leq mS(x)<J(x)+1$. 从而$\frac{J(x)}{m}\leq S(x)\leq\frac{J(x)+1}{m}$, $K(x)+\frac{J(x)}{m}\leq K(x)+S(x)\leq K(x)+\frac{J(x)+1}{m}$.
